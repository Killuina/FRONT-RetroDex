          ...
          <Link href="/" aria-label="to Home page">
            ...
            >
              <path
                ...
                fill={router.pathname === "/" ? "#b52222" : "black"}
              />
            </svg>
          </Link>
        </li>
          ...
          <Link href="/your-pokemon" aria-label="to My Pokémon page">
            ...
            >
              <path
                ...
                fill={router.pathname === "/your-pokemon" ? "#b52222" : "black"}
              />
            </svg>
          </Link>
        </li>
            ...
            <Link href="/create" aria-label="to Create Pokémon page">
              ...
              >
                <path
                  ...
                  fill={router.pathname === "/create" ? "#b52222" : "black"}
                />
              </svg>
            </Link>
          </li>
            ...
            <Link href="/login" aria-label="to Login page">
              ...
              >
                <path
                  ...
                  fill={router.pathname === "/login" ? "#b52222" : "black"}
                />
              </svg>
            </Link>
          </li>
